...
return static function (ContainerConfigurator $configurator): void {
    ...
    $services
        ->set(Yivoff\JwtRefreshBundle\Test\Resource\PurgableInMemoryRefreshTokenProvider::class)
    ;

    $configurator->extension(
        'yivoff_jwt_refresh',
        [
            'token_provider_service' => Yivoff\JwtRefreshBundle\Test\Resource\PurgableInMemoryRefreshTokenProvider::class,
        ]
    );
